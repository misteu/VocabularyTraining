...
extension LanguageScreenViewController: UITableViewDelegate {
    ...
    fileprivate func showNoData() {
        ...
        //you can change this to whatever string you want for your app. I just thought it was good to use again. 
        noDataLbl.text = NSLocalizedString("ℹ️ Add new words with the button below", comment: "ℹ️ Add new words with the button below")
        noDataLbl.textAlignment = .center
        noDataLbl.tag = 99
        noDataLbl.translatesAutoresizingMaskIntoConstraints = false
        
        NSLayoutConstraint.activate([
            noDataLbl.topAnchor.constraint(equalTo: tableView.topAnchor, constant: 20.0),
            noDataLbl.leadingAnchor.constraint(equalTo: tableView.leadingAnchor, constant: 20.0),
            noDataLbl.trailingAnchor.constraint(equalTo: tableView.trailingAnchor, constant: -20.0)
        ])
